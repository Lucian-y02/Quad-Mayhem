...
def platform_top(groups, x=0, y=0):
    WallHorizontal(group=groups["walls_horizontal"], x=x + 1, y=y, size=(28, 1))
    WallVertical(group=groups["walls_vertical"], x=x + 31, y=y + 1, size=(1, 31))
    WallVertical(group=groups["walls_vertical"], x=x, y=y + 1, size=(1, 31))


def platform_bottom(groups, x=0, y=0):
    WallHorizontal(group=groups["walls_horizontal"], x=x + 1, y=y + 32, size=(28, 1))
    WallVertical(group=groups["walls_vertical"], x=x + 31, y=y + 1, size=(1, 31))
    WallVertical(group=groups["walls_vertical"], x=x, y=y + 1, size=(1, 31))
