from objects import WallHorizontal, WallVertical
...
def platform_top_left(groups, x=0, y=0):  # 2
...
def platform_top_right(groups, x=0, y=0):  # 3
...
def platform_bottom_right(groups, x=0, y=0):  # 6
